...
export default function Policy() {
  return (
    <div className="All_policy">
      <p className="policy_head">
        Политика в отношении обработки персональных данных
      </p>
      <p className="big_p_policy">1. Общие положения</p>
      <p className="p_policy">
        ...
        безопасности персональных данных, предпринимаемые ArtOcean (далее —
        Оператор).
      </p>
      <p className="p_policy">
      ...
      <p className="p_policy">
        ...
        веб-сайта https://artocean-8eee9.web.app/.
      </p>
      <p className="big_p_policy">
      ...
      <p className="p_policy">
        ...
        в сети интернет по сетевому адресу https://artocean-8eee9.web.app/.
      </p>
      <p className="p_policy">
      ...
      <p className="big_p_policy">3. Основные права и обязанности Оператора</p>
      <p className="p_policy">3.1. Оператор имеет право:</p>
      <p className="p_policy">
      ...
      <p className="p_policy">3.2. Оператор обязан:</p>
      <p className="p_policy">
      ...
      <p className="p_policy">4.1. Субъекты персональных данных имеют право:</p>
      <p className="p_policy">
      ...
      <p className="p_policy">4.2. Субъекты персональных данных обязаны:</p>
      <p className="p_policy">
      ...
      <p className="big_p_policy">5. Принципы обработки персональных данных</p>
      <p className="p_policy">
      ...
      <p className="big_p_policy">6. Цели обработки персональных данных</p>
      <p className="p_policy">
        6.1. Цель обработки: обработка данных пользователей для сервиса онлайн -
        торговли
      </p>
      <p className="p_policy">
        6.2. Персональные данные: фамилия, имя, отчество, электронный адрес,
        номера телефонов, фотографии, адрес проживания
      </p>
      <p className="p_policy">
        6.3. Правовые основания: уставные (учредительные) документы Оператора
      </p>
      <p className="p_policy">
        6.4. Виды обработки персональных данных: Сбор, запись, систематизация,
        накопление, хранение, уничтожение и обезличивание персональных данных
      </p>
      <p className="big_p_policy">7. Условия обработки персональных данных</p>
      <p className="p_policy">
      ...
      <p className="p_policy">
        ...
        Оператора salamenikava77@gmail.com с пометкой «Актуализация персональных
        данных».
      </p>
      <p className="p_policy">
        ...
        Оператора salamenikava77@gmail.com с пометкой «Отзыв согласия
      ...
      <p className="big_p_policy">11. Конфиденциальность персональных данных</p>
      <p className="p_policy">
      ...
      <p className="big_p_policy">12. Заключительные положения</p>
      <p className="p_policy">
        ...
        к Оператору с помощью электронной почты salamenikava77@gmail.com.
      </p>
      <p className="p_policy">
      ...
      <p className="p_policy">
        ...
        Интернет по адресу https://artocean-8eee9.web.app/policy/.
      </p>
    </div>
  );
}
